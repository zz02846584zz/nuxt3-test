import { E as __nuxt_component_0, I as __nuxt_component_3$1, J as __nuxt_component_4$2, r as _sfc_main$m, L as __nuxt_component_4$1, d as useAsyncData } from '../server.mjs';
import { u as useLang } from './useLang.fa4f724f.mjs';
import { defineComponent, withAsyncContext, computed, ref, mergeProps, withCtx, unref, createTextVNode, toDisplayString, createVNode, openBlock, createBlock, Fragment, renderList, useSSRContext, reactive, createElementBlock, createElementVNode } from 'vue';
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_PageSection, { class: "flex-1 flex items-center" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`${ssrInterpolate(unref(topNews))} ${ssrInterpolate(unref(hotNews))} ${ssrInterpolate(unref(videoNews))} <div class="flex-1 md:w-5/8 flex flex-col z-10"${_scopeId3}><h1 class="text-center md:text-left mt-4"${_scopeId3}><!--[-->`);
                        ...
                        return [
                          createTextVNode(toDisplayString(unref(topNews)) + " " + toDisplayString(unref(hotNews)) + " " + toDisplayString(unref(videoNews)) + " ", 1),
...
//# sourceMappingURL=index.2dd473ed.mjs.map
